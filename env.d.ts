/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: d58ee09258af2b586d30626b24106a4c)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	RelayAgent: DurableObjectNamespace<import("./src/server").RelayAgent>;
	INFRA_WORKFLOW: Workflow<Parameters<import("./src/server").InfraWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RelayAgent";
	}
